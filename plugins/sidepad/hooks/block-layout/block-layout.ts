...
export function blockLayoutOf(
  ...
  // LIMIT(element-char-cap): a block whose source exceeds MAX_ELEMENT_CHARS characters is drawn as a note; its source is still readable under Source (Claude Code 2.1.280, #54).
