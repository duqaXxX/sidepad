...
export const FEATURE_PROOFS: Record<string, readonly Proof[]> = {
  'Opening and closing the pane': [
    ...
    { live: 'unasked-pane-waits-until-widened' },
  ...
  Themes: [
    { test: 'plugins/sidepad/tests/theme.test.ts' },
    { test: 'plugins/sidepad/tests/register.test.ts' },
    { test: 'plugins/sidepad/tests/surfaces.test.ts' },
    { live: 'theme-colour-names-resolve' },
  ],
  "The pane's frame": [
  ...
  'Reading a file': [
    ...
    { test: 'plugins/sidepad/tests/page-layout.test.ts' },
    { test: 'plugins/sidepad/tests/block-layout.test.ts' },
    { test: 'plugins/sidepad/tests/spans.test.ts' },
    { test: 'plugins/sidepad/tests/images.test.ts' },
    { test: 'plugins/sidepad/tests/delimited.test.ts' },
    { test: 'plugins/sidepad/tests/tables.test.ts' },
    { test: 'plugins/sidepad/tests/table-page.test.ts' },
    ...
    { live: 'a-diff-that-is-not-one-draws-plain' },
    { live: 'a-table-switches-to-its-source' },
  ],
  'Selecting a passage': [
    { test: 'plugins/sidepad/tests/pane-state.test.ts' },
    ...
    { live: 'drag-across-blocks-paints-the-gap' },
