...
| Themes | `/sidepad theme` picks `auto`, `classic` or `contrast` for the pane's colours |
...
time, currently Claude Code 2.1.280, and carries no code for an earlier one until mods are released.
